...
- Iterator nigdy nie są unieważniane, co zapewnia stabilność podczas operacji, choć podczas wymiany (`swap`) wskazują na te same elementy, zmieniając ich wartości.
